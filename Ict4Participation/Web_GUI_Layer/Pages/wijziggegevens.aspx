                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <div class="checkbox">
						                                <label>
							                                <input id="cb_ovmogelijkheid" type="checkbox" value="ovmogelijkheid" runat="server" />
							                                <span></span>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <div class="checkbox">
						                                <label>
							                                <input id="cb_rijbewijs" type="checkbox" value="rijbewijs" runat="server" />
							                                <span></span>
							                                <span>Rijbewijs</span>
						                                </label>
					                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <div class="checkbox">
						                                <label>
							                                <input id="cb_auto" type="checkbox" value="auto" runat="server" />
							                                <span></span>
							                                <span>Auto</span>
						                                </label>
					                                </div>
